...
public class ZaznamRegistraListRequest {
    ...
    public ZaznamRegistraListRequest order(OrderEnumModel order) {
        this.order = order;
        return this;
    }
    ...
    @Valid
    @ApiModelProperty(required = false)
    public OrderEnumModel getOrder() {
        return order;
    }

    public void setOrder(OrderEnumModel order) {
        this.order = order;
    }
