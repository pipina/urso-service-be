...
public class Or extends CompositeCondition {
	...
	public Or(ConditionIHasParameters c1, ConditionIHasParameters c2) {
		super(c1, c2);
	}

	public Or(ConditionIHasParameters[] conditions) {
		super(conditions);
	}

	public Or(List<? extends ConditionIHasParameters> conditions) {
		super(conditions);
	}
