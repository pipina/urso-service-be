...
@Getter
@Setter
@Entity(name="RA_1_INDEX")
public class RaReg1IndexEntity extends AbstractRegEntityIndex {
    @ToString.Exclude // nechceme vztahy v toString, nefunguje to bez transakcie lebo je to LAZY
    @ManyToOne(targetEntity = RaReg1DataEntity.class, fetch = FetchType.LAZY, optional = false)
