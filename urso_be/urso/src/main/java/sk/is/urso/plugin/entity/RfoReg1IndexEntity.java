...
@Getter
@Setter
@Entity(name="RFO_1_INDEX")
public class RfoReg1IndexEntity extends AbstractRegEntityIndex {
    @ToString.Exclude // nechceme vztahy v toString, nefunguje to bez transakcie lebo je to LAZY
    @ManyToOne(targetEntity = RfoReg1DataEntity.class, fetch = FetchType.LAZY, optional = false)
