...
public class TPOBPHRO
{
    ...
    protected String cb;
    @XmlElement(name = "IA", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    protected String ia;
    @XmlElement(name = "VD", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    protected Integer vd;
    @XmlElement(name = "DI", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    protected Integer di;
    @XmlElement(name = "UI", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    protected Integer ui;
    @XmlElement(name = "CE", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    protected Integer ce;
    @XmlElement(name = "OA", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
