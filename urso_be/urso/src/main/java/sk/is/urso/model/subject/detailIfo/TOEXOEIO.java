...
public class TOEXOEIO {
    ...
    @XmlElement(name = "UC", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    protected String mn;
    @XmlElement(name = "SN", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    protected Integer sn;
    @XmlElement(name = "STASNNA", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false)
    protected String stasnna;
    @XmlElement(name = "PI", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    @XmlElement(name = "RS", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    protected String rm;
    @XmlElement(name = "NI", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    @XmlElement(name = "UE", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    protected String um;
    @XmlElement(name = "SU", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    protected String bi;
    @XmlElement(name = "TV", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    @XmlElement(name = "UL", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    @XmlElement(name = "UO", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    protected String ic;
    @XmlElement(name = "SZ", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    @XmlElement(name = "RN", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    ...
    protected String dp;
    @XmlElement(name = "PA", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
    protected Integer pa;
    @XmlElement(name = "PG", namespace = "http://www.dominanz.sk/UVZ/Reg/FO", required = false, nillable = true)
